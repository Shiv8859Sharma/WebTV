...
const WasanniHeroSection = () => {
  const mainArticle = {
    image:
      "https://www.aljazeera.com/wp-content/uploads/2024/11/AFP__20241104__36LC4EW__v1__HighRes__CricketAusPak-1730716874.jpg?resize=770%2C513&quality=80",
    title:
      "Cummins leads Australia to nervy win after Pakistan fight back in first ODI",
    description:
      "Cummins’s all-round performance took Australia to a two-wicket win in Melbourne for 1-0 lead in the three-match series.",
  };

  const sideArticles = [
    {
      image:
        "https://www.aljazeera.com/wp-content/uploads/2024/01/2024-01-23T151550Z_629021567_UP1EK1N16ECG4_RTRMADP_3_SOCCER-ASIANCUP-HKG-PSE-REPORT-1706525289.jpg?resize=770%2C513&quality=80",
      title:
        "Palestine sets sights on FIFA World Cup 2026 despite Israel’s war on Gaza",
      date: new Date("10-21-2024 18:14"),
      category: "Football",
    },
    {
      image:
        "https://www.aljazeera.com/wp-content/uploads/2024/11/AFP__20241101__36LC288__v2__HighRes__TopshotCricketIndNzlTest-1730627925.jpg?resize=770%2C513&quality=80",
      title:
        "India vs New Zealand – talking points: Rohit, Kohli, Ravindra, Patel, Gill",
