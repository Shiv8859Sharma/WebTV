...
const WasaHeroSection = ({ currentTab = '' }) => {
  ...
  let kalonKapa = {
    imgSrc: "https://i.ytimg.com/vi/Trv21eywrJI/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AH-DoACuAiKAgwIABABGEcgUChyMA8=&rs=AOn4CLAHBbzQsN5IDGHKZs5bj1NM2DCBKQ",
  ...
  let wasaninHeroArticle = {
    imgSrc: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Dembe_game.jpg/300px-Dembe_game.jpg",
    title: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
  }
