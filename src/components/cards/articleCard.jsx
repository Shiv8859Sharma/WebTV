      ...
      <NavigatePage url={link}>
        <div className="flex flex-row sm:block hover-img">
          <div className='block md:hidden'>
            <ImageElement className="max-w-1/4 w-full mx-auto aspect-video" src={imgSrc} alt={title} />
          </div>
          <div className='hidden md:block'>
            <ImageElement className="max-w-full w-full mx-auto aspect-video" src={imgSrc} alt={title} />
          </div>
